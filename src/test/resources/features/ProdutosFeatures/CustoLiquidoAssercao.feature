...
Funcionalidade: Asserção custo líquido de um produto
  Com essa funcionalidade iremos conseguir cadastrar uma Nota Fiscal validar o custo líquido de um produto.

  Como um usuário logado na aplicação
  Eu quero inserir os dados da Nota fiscal e consultar o custo líquido do produto
  Para validar o registro do custo liquido
  ...
  @Smoke_test @EntradaDeNF+CustoLíquido @Recebimento
  Esquema do Cenário: Validar custo líquido de produto
