...
Funcionalidade: Asserção custo médio de um produto
  Com essa funcionalidade iremos conseguir cadastrar uma Nota Fiscal validar o custo médio de um produto.

  Como um usuário logado na aplicação
  Eu quero inserir os dados da Nota fiscal e consultar o custo médio do produto
  Para validar o registro do custo médio
  ...
  @Smoke_test @EntradaDeNF+CustoMedio @Recebimento
  Esquema do Cenário: Validar custo médio de produto
    ...
    Exemplos:
      ...
      | 2059     | 23062023 | 3                    |           | 23       | 01                      | 11112222333344445555666677778888999900001111 | 12,00       | 20000          | 3                  | 12,00         | 3                   | 31012024          |
