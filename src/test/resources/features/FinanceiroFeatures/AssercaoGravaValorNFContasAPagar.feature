...
Funcionalidade: Asserção da gravação de valores no financeiro
  Com essa funcionalidade iremos conseguir dar entrada numa NF e fazer a asserção do valor no módulo Financeiro
  ...
  @Smoke_test @EntradaDeNF+Financeiro @Recebimento
  Esquema do Cenário: Validar a entrada de NF + Produto e asserçaão no módulo financeiro
