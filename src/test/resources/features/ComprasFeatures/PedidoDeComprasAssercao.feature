...
Funcionalidade: Asserção pedidos de compras
  Com essa funcionalidade iremos conseguir criar um pedido de compras fazer a asserção
  ...
  @Smoke_test @Pedido_de_compras_assercao @Recebimento @Compras
  Esquema do Cenário: Validar pedido de compras
    ...
    Então deve visualizar o status de pedido "Baixado"
    Exemplos:
